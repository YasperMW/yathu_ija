            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-2 page-more-info">
                    ...
                    <ul>
                        ...
                        <li><a href="book_seat.php">Book a seat</a></li>
                        <li><a href="book_bus.php">Hire A Bus</a></li>
                        <li><a href="my_profile.php">My profile</a></li>
                        <li><a href="check_tickets.php">My Tickets</a></li>
                ...
                <div class="col-md-6 col-lg-3 page-more-info">
                    ...
                    <ul>
                        <li><a href="mailto:archives@sdnp.org.mw">yankhochisale4@gmail.com</a></li>
                        <li><a href="tel:(265) 997 823 454">+265 997 823 454 </a></li>
                        <li><a href="tel:(265) 883 271 664">+265 883 271 664</a></li>
                    </ul>
                </div>
